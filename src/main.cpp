...
#if defined(NDEBUG)
# error "Hóuziyìngbì cannot be compiled without assertions."
#endif
...
unsigned int nModifierInterval = 9 * 60; // time to elapse before new restaking can occur
...
const string strMessageMagic = "Hóuziyìngbì Signed Message:\n";
...
{
    RenameThread("hóuziyìngbì-loadblk");
